...
const ChatBot = () => {
  ...
  const baseURL = "https://yugen-service.onrender.com";
  ...
  return (
    <div className="flex gap-6 mt-[30px] ml-[30px]">
      ...
      <div className="flex flex-col gap-2">
        <div className="w-[460px] h-[300px] flex flex-col border border-black rounded-xl p-4 bg-white shadow-[rgb(204,219,232)_3px_3px_6px_0px_inset,rgba(255,255,255,0.5)_-3px_-3px_6px_1px_inset] max-h-[560px] overflow-y-auto">
          <button
          ...
          {chatHistory.map((chat) => (
            <button
              ...
              className={`text-left mb-2 px-3 py-2 rounded-xl hover:bg-[#6D6AEF] hover:text-white transition-colors duration-300 ${
            ...
            >
              ...
              <div className="text-xs  truncate">{chat.usermsg}</div>
            </button>
          ))}
        </div>
